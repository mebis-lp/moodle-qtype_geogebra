...
$string['enable_right_click'] = 'Sağ Tık, Zomlama ve Klavye Düzenlemeye izin ver';
...
$string['ggbturl'] = 'GeoGebraTube Çalışma Sayfasına ait URL veya ID';
$string['ggbturl_help'] = 'GeoGebraTube\'de paylaş düğmesini kullanıp bağlantıyı kopyalayıp yapıştırabilir veya GeoGebraTube havuzunu kullanabilirsiniz. Applet ve parametreler veri tabanına yüklendi; applet, talep edilmedikçe GeoGebraTube\'den yeniden yüklenmeyecektir. Applet\'ın sadece ID veya paylaşım anahtarının sunulması desteklenmektedir.';
...
$string['loadapplet_help'] = 'Applet\'ı GeoGebraTube\'den (yeniden) yükleyiniz ve yeni versiyonu GeoGebraTube\'den veri tabanına depolayınız.';

...
$string['ggbturl'] = 'URL-ul sau ID-ul al fișei de lucru GeoGebraTube';
$string['ggbturl_help'] = 'Ai putea folosi fie butonul de partajare de la GeoGebraTube și copiați și inserați link-ul sau utilizați magazia GeoGebraTube. Applet-ul și parametrii sunt stocate în baza de date, applet-ul nu va fi reîncărcată din GeoGebraTube excepția cazului în care a solicitat. Doar asigurarea ID-ul sau partajarea cheie al applet-uluicare este suportat';
...
$string['loadapplet_help'] = '(Re)încărcați applet-ul de la GeoGebraTube și depozitați noua versiune din GeoGebraTube în baza de date.';

...
$string['getvars'] = 'Doloži spremenljivke iz apleta, ki naj bodo slučajne';
...
$string['ggbturl'] = 'URL ali ID gradiva na GeoGebraTube';
...
$string['loadapplet_help'] = '(Ponovno) naloži aplet iz GeoGebraTube shrani novo verzijo iz GeoGebraTube v bazo.';

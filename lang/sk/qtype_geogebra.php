...
$string['ggbturl_help'] = 'Môžete použiť buď tlačidlo Šíriť na stránke GeoGebraTube a kopírovať a vložiť odkaz, alebo použite úložisko GeoGebraTube. Applet a parametre appletu sú uložené priamo v databáze, applet nebude znova načítaný z GeoGebraTube, ak o to nepožiadate. Tiež je podporované aj to, že stačí poskytnúť ID alebo kľúč šírenia appletu.';

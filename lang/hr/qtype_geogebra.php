...
$string['ggbturl'] = 'URL ili ID ili GeoGebra uradak';
...
$string['loadapplet_help'] = '(Ponovno)učitaj aplet s GeGebraTube i spremi novu verziju s GeoGebra u bazu podataka.';

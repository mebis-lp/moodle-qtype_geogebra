...
$string['enable_right_click'] = 'Salli hiiren oikean painikkeen klikkaaminen, zoomaus ja muokkaaminen näppäimistöllä';
...
$string['ggbturl'] = 'URL tai ID GeoGebraTuben työkirjaan';
$string['ggbturl_help'] = 'Voit käyttää joko Jaa-painiketta GeoGebraTubessa ja kopioida ja liittää linkin, tai käyttää GeoGebraTuben säilytyspaikkaa. Appletti ja parametrit tallennetaan tietokantaan, eikä applettia ladata uudelleen GeoGebraTubesta, ellei sitä pyydetä. Pelkkä ID:n antamista tai appletin avaimen jakamista on myös tuettu ominaisuus.';
...
$string['loadapplet_help'] = 'Lataa appletti (uudelleen) GeoGebraTubesta ja varastoi uusi versio GeoGebraTubesta tietokantaan.';

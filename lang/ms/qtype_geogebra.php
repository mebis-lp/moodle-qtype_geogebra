...
$string['randomizedvar_help'] = 'Pembolehubah-pembolehubah ynag harus dirawakkan (diasingkan dengan koma). Gunakan opsyen slider dalam GeoGebra untuk menyatakan Minimum, Maksimum dan Peningkatan. Pembolehubah-pembolehubah ini boleh digunakan teks soalan dengan menutupkannya dengan kurungan rungkup, sebagai contoh: {a}';

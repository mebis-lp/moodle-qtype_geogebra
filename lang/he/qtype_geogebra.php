...
$string['ggbturl'] = 'כתובת רשת או מספר זהות לגליון GeoGebraTube‏';
$string['ggbturl_help'] = 'את יכולה להשתמש בכפתור השיתוף ב-GeoGebraTube ולהעתיק ולהדביק את הקישור, או להשתמש במאגר GeoGebraTube‏. היישומון והפרמטרים באוכסנים בבסיס הנתונים. היישומון לא יועלה שוב מ-GeoGebraTube אלא אם יתבקש. ניתן גם רק לספק את ה-ID או מפתח השיתוף של היישומון.';
...
$string['loadapplet_help'] = 'טען (מחדש) את היישומון מ-GeoGebraTube ואחסן את הגסה החדשה מ-GeoGebraTube בבסיס הנתונים.';

...
$string['ggbturl'] = 'URL of ID van het GeoGebraTube werkblad';
$string['ggbturl_help'] = 'Je kunt ofwel de knop \'delen\' gebruiken in GeoGebraTube en de link kopiëren en plakken ofwel de GeoGebraTube opslagruimte gebruiken. Het applet en de parameters worden opgeslagen in de database, het applet wordt niet opnieuw ingeladen vanuit GeoGebraTube tot dit gevraagd wordt. Enkel het ID van het applet of de code om te delen wordt ook ondersteund.';
...
$string['loadapplet_help'] = '(Her)laad het applet vanuit GeoGebraTube en sla de nieuwe versie van GeoGebraTube op in de database.';

...
$string['ggbturl_help'] = 'Μπορείτε είτε να χρησιμοποιήσετε το κουμπί διαμοιρασμού στο GeoGebraTube και να αντιγράψετε και να επικολλήσετε τον σύνδεσμο ή χρησιμοποιήστε το αποθετήριο του GeoGebraTube. Η εφαρμογή και οι παράμετροι αποθηκεύονται στη βάση δεδομένων, η εφαρμογή δεν θα φορτωθεί από GeoGebraTube εκτός εάν ζητηθεί. Υποστηρίζεται επίσης η  παροχή ταυτότητας ID ή κουμπί διαμοιρασμού .';

...
$string['ggbturl_help'] = '你或者可以使用 GeoGebra 中的分享按钮复制粘贴链接, 或者使用 GeoGebra 库. Java程序和参数保存在数据库中, 除非有要求, Java程序将会从 GeoGebra 中重新载入. 只需提供 ID 或 Java程序的共享密钥也能得到支持.';
...
$string['loadapplet_help'] = '从 GeoGebra (重新)载入Java程序并将 GeoGebra 中的新版本保存进数据库.';

...
$string['loadapplet_help'] = '从 GeoGebraTube (重新)载入 applet 并将 GeoGebraTube 中的新版本保存进数据库.';
...
$string['noappletloaded'] = '无 Applet 载入! 检查一下网址是否正确，并确定选择一个链接或者（重新）载入 Applet 后是否能看见它';

...
$string['ggbturl_help'] = '您或者可以使用 GeoGebraTube 中的分享按钮复制粘贴链接，或者使用 GeoGebraTube 库. Java程序 和参数保存在数据库中, 除非有要求，Java程序将会从 GeoGebraTube 中重新载入. 只需提供 ID 或 Java程序的共享密钥也能得到支持.';

...
$string['constraints_help'] = '如同不能在滑动条选项中作标识的 a < b 的变量, 对它们有限制吗? 以逗号分隔. 支持的关系有: <, <=, >, >=. 如需要等式, 你就不得不在创建GeoGebra课件时使用同一变量. 运用变量作为滑动条的最小值/最大值的动态区间是得不到支持的.';
$string['constraintswrongortoohard'] = '{$a->inequalities} 是错误的或难以满足的, 在 {$a->time} 秒内我们(强力)尝试了 {$a->tries} 次. 也许我们将来会用更好的方法…';
$string['dragndrop'] = '在GeoGebra Java程序部分拖放GeoGebra文件';
$string['enable_label_drags'] = '启用拖动标签';
$string['enable_right_click'] = '启用右击, 缩放及键盘编辑';
$string['enable_shift_drag_zoom'] = '启用上档键-拖动及缩放';
$string['feedback'] = '变量为真时反馈';
$string['feedback_help'] = '反馈自动地从GeoGebra文件中的变量标题中采纳.';
$string['geogebraapplet'] = 'GeoGebra Java 程序';
$string['getvars'] = '从 Java 程序中取得能被随机化的变量';
$string['ggbfilemissing'] = '响应中的 Base64 编码字符串丢失, 可能是浏览器中的 JavaScript 没有打开或者出现了未知的错误';
$string['ggbturl'] = 'GeoGebra课件网址或者ID';
$string['ggbturl_help'] = '你或者可以使用 GeoGebra 中的分享按钮复制粘贴链接, 或者使用 GeoGebra 库. Java 程序和参数保存在数据库中, 除非有要求, Java 程序将会从 GeoGebra 中重新载入. 只需提供 ID 或 Java 程序的共享密钥也能得到支持.';
...
$string['isexercise_help'] = '该 Java 程序含有用户定义的可用于自动检查练习的工具.\n注意: 下面所有答案在此案例中不适用!';
$string['israndomized'] = '存在应当随机化的变量吗?';
$string['loadapplet'] = '(重新)载入并显示 Java 程序';
$string['loadapplet_help'] = '从 GeoGebra(重新)载入 Java 程序并将 GeoGebra 中的新版本保存进数据库.';
$string['mineqmax'] = '对于随机化的最小值和最大值为变量 {$a} 指定得不正确, 你或者还没有指定滑动条的最小值和最大值或者该元素根本就不是滑动条. 你可能不得不在GeoGebra文件中纠正它.';
$string['minplusstepgtmax'] = '变量 {$a} 的最小值加上增量大于最大值, 你可能不得不在GeoGebra文件中纠正它.';
$string['noappletloaded'] = '无 Java 程序载入! 检查一下网址是否正确, 并确定选择一个链接或者(重新)载入 Java 程序后是否能看见它';
$string['nofractionsumeq1'] = '至少成绩的一个组合总和必须为 100%';
$string['pluginname_help'] = '学生能用GeoGebra解决的问题';
$string['pluginnameadding'] = '添加GeoGebra问题';
$string['pluginnameediting'] = '编辑GeoGebra问题';
$string['pluginnamesummary'] = '测验时运用GeoGebra显示问题并验证答案的计算问题版本.';
$string['randomizedbutnovars'] = '你已经选择了应该随机化的问题, 但你没有指定任何可随机化的有效变量.';
$string['randomizedvar'] = '随机变量';
$string['randomizedvar_help'] = '随机变量 (逗号隔开). 使用GeoGebra中的滑动条选项, 标识最小值、最大值和增量. 这些变量也可以应用于问题文本中, 并以大括号将它们括起来, 例如: {a}';
$string['show_algebra_input'] = '显示输入栏';
$string['show_menu_bar'] = '显示菜单';
$string['show_reset_icon'] = '显示重置作图图标';
$string['show_tool_bar'] = '显示工具栏';
$string['stepzero'] = '变量 {$a} 的增量为0; 你或者没有指定滑动条的增量, 或者该元素根本就不是一个滑动条. 你可能不得不在GeoGebra文件中纠正它.';
$string['useafile'] = '... 或者使用 ggb 文件';
$string['valuecheckedfor'] = 'GeoGebra中用于检查正确性的布尔对象';

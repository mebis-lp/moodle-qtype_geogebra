...
$string['noappletloaded'] = '¡No hay applet alguna cargada! Conviene comprobar si la URL es correcta o si se observa un applet después de elegir un enlace o (re)cargar el applet';
